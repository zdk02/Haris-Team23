...
def _play(orch: Orchestrator) -> None:
    """Run the whole scenario battery through one orchestrator (used for both the warm-up
    and the measured pass, reusing the same warm agent instances)."""
    for sc in SCENARIOS:
